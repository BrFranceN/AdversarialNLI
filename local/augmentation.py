...
# print(f"premise {nli_dataset['train']['premise'][20]}")
# print(f"hypothesis {nli_dataset['train']['hypothesis'][20]}")
# print(f"label {nli_dataset['train']['label'][20]}")
# print(f"srl {nli_dataset['train']['srl']['hypothesis'][20]}")
# print(f"wsd -> {nli_dataset['train']['wsd'][9]}")
...
# tokenized_datasets_sst2 = nli_dataset.map(tokenize_function, batched=True)
